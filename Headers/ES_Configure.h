...
#define SERV_0_HEADER "Gameplay.h"
// the name of the Init function
#define SERV_0_INIT InitGameplay
// the name of the run function
#define SERV_0_RUN RunGameplay
...
#if NUM_SERVICES > 1
// the header file with the public function prototypes
#define SERV_1_HEADER "EventGenerator.h"
// the name of the Init function
#define SERV_1_INIT InitEventGenerator
// the name of the run function
#define SERV_1_RUN RunEventGenerator
// How big should this services Queue be?
...
#if NUM_SERVICES > 2
// the header file with the public function prototypes
#define SERV_2_HEADER "EventPrinter.h"
// the name of the Init function
#define SERV_2_INIT InitEventPrinter
// the name of the run function
#define SERV_2_RUN RunEventPrinter
// How big should this services Queue be?
...
#if NUM_SERVICES > 3
// the header file with the public function prototypes
#define SERV_3_HEADER "Cities.h"
// the name of the Init function
#define SERV_3_INIT InitCities
// the name of the run function
#define SERV_3_RUN RunCities
// How big should this services Queue be?
...
#if NUM_SERVICES > 4
// the header file with the public function prototypes
#define SERV_4_HEADER "Hose.h"
// the name of the Init function
#define SERV_4_INIT InitHose
// the name of the run function
#define SERV_4_RUN RunHose
// How big should this services Queue be?
...
#if NUM_SERVICES > 5
// the header file with the public function prototypes
#define SERV_5_HEADER "Pump.h"
// the name of the Init function
#define SERV_5_INIT InitPump
// the name of the run function
#define SERV_5_RUN RunPump
// How big should this services Queue be?
...
#if NUM_SERVICES > 6
// the header file with the public function prototypes
#define SERV_6_HEADER "Stir.h"
// the name of the Init function
#define SERV_6_INIT InitStir
// the name of the run function
#define SERV_6_RUN RunStir
// How big should this services Queue be?
...
#if NUM_SERVICES > 7
// the header file with the public function prototypes
#define SERV_7_HEADER "LEDControl.h"
// the name of the Init function
#define SERV_7_INIT InitLEDControl
// the name of the run function
#define SERV_7_RUN RunLEDControl
// How big should this services Queue be?
...
#if NUM_SERVICES > 8
// the header file with the public function prototypes
#define SERV_8_HEADER "Buttons.h"
// the name of the Init function
#define SERV_8_INIT InitButtons
// the name of the run function
#define SERV_8_RUN RunButtons
// How big should this services Queue be?
...
#if NUM_SERVICES > 9
// the header file with the public function prototypes
#define SERV_9_HEADER "TimeOfDay.h"
// the name of the Init function
#define SERV_9_INIT InitTimeOfDay
// the name of the run function
#define SERV_9_RUN RunTimeOfDay
// How big should this services Queue be?
...
#if NUM_SERVICES > 10
// the header file with the public function prototypes
#define SERV_10_HEADER "fsdsdf.h"
// the name of the Init function
#define SERV_10_INIT sdsd
// the name of the run function
#define SERV_10_RUN sdfsdf
// How big should this services Queue be?
...
#if NUM_DIST_LISTS > 0 
#define DIST_LIST0 PostGameplay, PostEventPrinter
#endif
#if NUM_DIST_LISTS > 1 
...
#define EVENT_CHECK_LIST Check4Keystroke, checkIREvents, CheckPumpLevel, CheckStirState
...
#define TIMER0_RESP_FUNC PostGameplay // post to Gameplay
#define TIMER1_RESP_FUNC PostGameplay// post to Gameplay
#define TIMER2_RESP_FUNC PostGameplay // post to Gameplay
#define TIMER3_RESP_FUNC TIMER_UNUSED
#define TIMER4_RESP_FUNC PostStir // post to Stir
#define TIMER5_RESP_FUNC PostTimeOfDay // post to TimeOfDay
#define TIMER6_RESP_FUNC PostPump // post to Pump
#define TIMER7_RESP_FUNC PostHose // post to Hose
#define TIMER8_RESP_FUNC PostLEDControl // post to LEDControl
#define TIMER9_RESP_FUNC PostButtons // post to Buttons
#define TIMER10_RESP_FUNC PostGameplay
...
#define GAME_TIMER 0
#define INACTION_TIMER 1
#define GAME_STATE_TIMER 2
#define STIR_TIMER 4
#define TIME_OF_DAY_TIMER 5
#define PUMP_TIMER 6
#define AMMO_TIMER 7
#define LED_FLASH_TIMER 8
#define BUTTON_TIMER 9
#define FLAG_WAVE_TIMER 10
